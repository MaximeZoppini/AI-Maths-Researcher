...
# mkdir -p "${DEST_DIR}"
# cp "/Users/maxime/Documents/antigravity/optimistic-curie/AI-Maths-Researcher/submissions/aime_1983_p1/aime_1983_p1.lean" "${DEST_DIR}/aime_1983_p1.lean"
...
# git add "${DEST_DIR}/aime_1983_p1.lean"
# git commit -m "feat(Mathlib): formalize ${TARGET}"
# git push -u origin "${BRANCH}"

# ÉTAPE 6 : Création de la Pull Request via gh CLI
# gh pr create --repo "${REPO}" --title "feat(Mathlib): formalize ${TARGET}" --body-file "/Users/maxime/Documents/antigravity/optimistic-curie/AI-Maths-Researcher/submissions/aime_1983_p1/PR_BODY.md"
