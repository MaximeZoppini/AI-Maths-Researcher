...
# mkdir -p "${DEST_DIR}"
# cp "/Users/maxime/Documents/antigravity/optimistic-curie/AI-Maths-Researcher/submissions/Problem2_ModThreeSquare/Problem2_ModThreeSquare.lean" "${DEST_DIR}/Problem2_ModThreeSquare.lean"
...
# git add "${DEST_DIR}/Problem2_ModThreeSquare.lean"
# git commit -m "feat(Mathlib): formalize ${TARGET}"
# git push -u origin "${BRANCH}"

# ÉTAPE 6 : Création de la Pull Request via gh CLI
# gh pr create --repo "${REPO}" --title "feat(Mathlib): formalize ${TARGET}" --body-file "/Users/maxime/Documents/antigravity/optimistic-curie/AI-Maths-Researcher/submissions/Problem2_ModThreeSquare/PR_BODY.md"
